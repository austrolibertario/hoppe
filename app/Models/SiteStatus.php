    ...
    public static function newUser($driver)
    {
        ...
        switch ($driver) {
            case 'github':
                ...
                break;
            case 'google':
                self::collect('new_user_from_google');
                break;
            case 'twitter':
                self::collect('new_user_from_twitter');
                break;
            case 'facebook':
                self::collect('new_user_from_facebook');
                break;
            case 'wechat':
    ...
    public static function collect($subject)
    {
        ...
        switch ($subject) {
            ...
            case 'new_user_from_github':
                ...
                break;
            case 'new_user_from_google':
                $todayStatus->google_regitster_count += 1;
                break;
            case 'new_user_from_twitter':
                $todayStatus->twitter_regitster_count += 1;
                break;
            case 'new_user_from_facebook':
                $todayStatus->facebook_regitster_count += 1;
                break;
