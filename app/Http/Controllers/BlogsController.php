...
class BlogsController extends Controller
{
    ...
    {
        $blogs = Blog::recent()->paginate(15);
        return view('blogs.index', compact('blogs', 'currentUserId'));
    }
    ...
    public function subscribe($id)
    {
        ...
        Flash::success("Inscrição feita com sucesso");
    ...
    public function unsubscribe($id)
    {
        ...
        Flash::success("Inscrição no blog cancelada com sucesso");
