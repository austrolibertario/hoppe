<?php
// Tais como: db: seed ou limpar a localização do comando da base de dados
function insanity_check()
{
    if (App::environment('production')) {
        exit('Não seja estúpido, este é o ambiente online.');
    }
}
...
function transform_to_slug($slug)
{
    return str_replace(array(" "), array(""), $slug);
}
...
/**
 * Gere um link para a tecnologia de esquema de URL do cliente usuário.
 */
...
// Veja: https://developer.qiniu.com/dora/api/basic-processing-images-imageview2
...
function linkWithUTMSource($link)
{
    $append = 'utm_source=h3sotospeak.com';
