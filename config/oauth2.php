...
return [
    ...
    */
    ...
    'grant_types' => [
        ...
        // Tempo de expiração do Accesstoken, em segundos, em segundos, preste atenção para lembrar os usuários de reautorizar quando expirarem
         // Similar a:
        ...
        /*
         * Use quando o usuário não estiver logado, pode acessar alguns recursos
         */
        'client_credentials' => [
        ...
        /*
         * Use este método de autorização para atualizar os Tokens expirados
         */
        'refresh_token' => [
