...
return [
    ...
    */
    ...
    /*
     * Número padrão por página
     */
    'default_per_page' => env('API_DEFAULT_PER_PAGE', 15),

    /*
     * Número máximo de páginas únicas que podem aceitar solicitações
     */
    'max_per_page' => env('API_MAX_PER_PAGE', 30),

    /*
     * Limite de frequência de interface
     */
    'rate_limits' => [

        // Limite de frequência de acesso, número de vezes / minuto
        'access' => [
            'expires' => env('RATE_LIMITS_EXPIRES', 1),
            'limits'  => env('RATE_LIMITS', 60),
        ],

        // Limite de frequência de lançamento (postagem e comentários), tempos / minuto
        'publish' => [
