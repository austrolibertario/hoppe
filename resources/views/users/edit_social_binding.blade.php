        ...
        <form class="form-horizontal" method="POST" action="{{ route('users.update_email_notify', $user->id) }}" accept-charset="UTF-8">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    ...
                    <a class="btn btn-info login-btn {{ $user->register_source == 'facebook' ? '' : 'hide' }}" role="button">
                      <i class="fa fa-facebook-alt"></i>
                      Facebook
                    </a>

                    <a class="btn btn-info login-btn {{ $user->register_source == 'twitter' ? '' : 'hide' }}" role="button">
                      <i class="fa fa-twitter"></i>
                      Twitter
                    </a>

                    <a class="btn btn-info login-btn {{ $user->register_source == 'google' ? '' : 'hide' }}" role="button">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-9">
                    ...
                    @if($user->register_source != 'facebook')
                        ...
                        @else
                        <a href="{{ URL::route('auth.oauth', ['driver' => 'facebook']) }}" class="btn btn-default login-btn">
                        @endif
                          <i class="fa fa-facebook-alt"></i>
                          Facebook
                        </a>
                    ...
                    @if($user->register_source != 'twitter')
                        @if($user->twitter_id > 0)
                        <a href="javascript:void(0);" class="btn btn-info login-btn">
                        @else
                        <a href="{{ URL::route('auth.oauth', ['driver' => 'twitter']) }}" class="btn btn-default login-btn">
                        @endif
                          <i class="fa fa-twitter"></i>
                          Twitter
                        </a>
                    ...
                    @if($user->register_source != 'google')
                        @if($user->google_id > 0)
                        <a href="javascript:void(0);" class="btn btn-info login-btn">
                        @else
                        <a href="{{ URL::route('auth.oauth', ['driver' => 'google']) }}" class="btn btn-default login-btn">
                        @endif
                          <i class="fa fa-google"></i>
                          Google
                        </a>
