...
@section('title')
Hans-Hermann Hoppe Brasil - Corredor da fama @parent
@stop
...
<div class="hall_of_fames">
    ...
    <div class="box text-center site-intro rm-link-color">
        O Hall da Fama do Hans-Hermann Hoppe Brasil é recomendado para usuários que tenham feito contribuições de destaque para a comunidade Hans-Hermann Hoppe Brasil.<a style="text-decoration: underline;" href="https://h3sotospeak.com/topics/2440">Mais informação</a>
    </div>
