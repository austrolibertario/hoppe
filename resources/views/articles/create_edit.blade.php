...
@section('title')
{{ $topic->id > 0 ? 'Editar artigo' : 'Criar artigo' }} | @parent
@stop
...
<div class="blog-pages">
  ...
  <div class="col-md-12 panel">
      ...
      <div class="panel-body">
            ...
            <h2 class="text-center"> {{ $topic->id > 0 ? 'Editar artigo' : 'Criar artigo' }}</h2>
            <hr>
                ...
                <div class="form-group status-post-submit">
                  <button class="btn btn-primary submit-btn" type="submit" name="subject" value="publish" id="{{ $topic->is_draft == 'yes' ? 'publish-hint' : '' }}">{{ lang('Publish') }}</button>
                    ...
                    @if($topic->is_draft == 'yes' || empty($topic->id))
                        &nbsp;&nbsp;or&nbsp;&nbsp;
                        <button class="btn btn-basic" type="submit" name="subject" value="draft">Salvar rascunho</button>
                    @endif
                </div>
            </form>
      </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function()
    {
        ...
        $('#publish-hint').click(function(event) {
            ...
            swal({
                title: "",
                text: "Tem certeza de que deseja publicar o rascunho?",
                type: "warning",
                ...
                "link", "image", "|",  "side-by-side", 'fullscreen', "|",
                {
                    ...
                    action: function customFunction(editor){
                        ...
                        if (win) {
                            ...
                            alert('Por favor permita popups para esse website');
                        }
                    },
                    className: "fa fa-info-circle",
                    title: "Sintaxe de marcação de texto!",
                },
                {
                    name: "publish",
                    action: function customFunction(editor){
