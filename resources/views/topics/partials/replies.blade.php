        ...
        <li class="list-group-item media"
            ...
            <div class="media-heading">
                ...
                @if ($reply->user->present()->isAdmin())
                    <a class="label label-success mod-label popover-with-html" data-content="Administrador" href="{{ route('roles.show', [$reply->user->present()->badgeID()]) }}">MOD</a>
                @endif
                ...
                @if ($currentUser && $reply->user_id && $reply->user_id != $currentUser->id)
                ...
                @if ($currentUser && $reply->user_id && ($manage_topics || $currentUser->id == $reply->user_id) )
                ...
                <div class="meta">
                    ...
                    ⋅ via
                        <a href="https://h3sotospeak.com/topics/1531" target="_blank" class="popover-with-html" data-content="来自手机客户端">
                        <i class="text-md fa fa-{{ $reply->source == 'iOS' ? 'apple' : 'android' }}" aria-hidden="true"></i> {{ $reply->source == 'iOS' ? 'iOS Cliente' : 'Cliente Android' }}
                        </a>
