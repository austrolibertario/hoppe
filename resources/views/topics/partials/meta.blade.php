...
⋅
via
    <a href="https://h3sotospeak.com/topics/1531" target="_blank" class="popover-with-html" data-content="Do cliente móvel">
      <i class="text-md fa fa-{{ $topic->source == 'iOS' ? 'apple' : 'android' }}" aria-hidden="true"></i> {{ $topic->source == 'iOS' ? 'Iphone' : 'Android' }}
    </a>
