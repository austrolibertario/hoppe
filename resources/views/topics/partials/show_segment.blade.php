    ...
    <div class="panel-body vote-box text-center">
        ...
        <div class="voted-users">
            ...
            @else
                ...
                <div class="vote-hint">
                    Seja o primeiro a curtir esse tópico <img title=":bowtie:" alt=":bowtie:" class="emoji" src="https://h3sotospeak.com/assets/images/emoji/bowtie.png" align="absmiddle"></img>
                </div>
            @endif
